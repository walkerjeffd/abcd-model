define([
  ...
  var Diagram = Backbone.View.extend({
    svg: ['<svg xmlns="http://www.w3.org/2000/svg" width="323px" height="307px" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">',
          ...
          '    </g>',
          '    <path d="M 130 140 L 130 130 L 190 130 L 190 120 L 220 135 L 190 150 L 190 140 Z" fill="#ffffff" stroke="#000000" stroke-miterlimit="10" pointer-events="none" id="comp-DR" class="component"/>',
          '    <path d="M 130 280 L 130 270 L 190 270 L 190 260 L 220 275 L 190 290 L 190 280 Z" fill="#ffffff" stroke="#000000" stroke-miterlimit="10" pointer-events="none" id="comp-GD" class="component"/>',
          '    <path d="M 64 165 L 74 165 L 74 205 L 84 205 L 69 235 L 54 205 L 64 205 Z" fill="#ffffff" stroke="#000000" stroke-miterlimit="10" pointer-events="none" id="comp-GR" class="component"/>',
